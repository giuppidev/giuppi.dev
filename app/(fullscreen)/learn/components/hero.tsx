...
export default function Hero() {
  return (
    <div className="font-worksans relative isolate  bg-myYellow border-b-4 border-b-gray-800">
      <div className="mx-auto max-w-7xl    lg:px-0 py-8 lg:py-24  lg:flex items-center justify-between lg:gap-x-10 ">
        <div className="mx-auto max-w-7xl lg:mx-0 lg:flex-auto px-4">
          <h1 className="  max-w-2xl flex-grow text-5xl font-semibold lg:font-medium tracking-tight text-gray-900 lg:text-8xl leading-tight ">
            Hi, I&apos;m Giuppi.
          </h1>
          <p className="mt-2  max-w-2xl text-xl leading-8 text-gray-800">
            I&apos;m a software developer with 10+ years of experience and my
            job is to teach coding to everyone.
          </p>
          <div className="mt-8 -ml-2 flex gap-2 ">
            <a
              href="mailto:info@giuppi.dev"
              className="bg-myGreen text-white font-medium flex gap-2 items-center my-0 mx-1 text-2xl   py-2 px-4 rounded-md border-2 border-gray-900 shadow-brutal cursor-pointer active:translate-y-1 active:shadow-[1px_2px_0px_0px_#000] "
            >
              Contact me <ArrowIcon />
            </a>
            <a
              target="_blank"
              href="https://www.youtube.com/@giuppidev"
              className="bg-red-500 text-white font-medium flex gap-2 items-center my-0 mx-1 text-2xl   py-2 px-4 rounded-md border-2 border-gray-900 shadow-brutal cursor-pointer active:translate-y-1 active:shadow-[1px_2px_0px_0px_#000] "
            >
              I make videos <ArrowIcon />
            </a>
        ...
        <div className=" lg:pl-16 mt-28  lg:mt-10 flex lg:block justify-center w-full md:w-auto px-8">
