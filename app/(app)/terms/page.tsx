export default function Policy() {
  return (
    <div className="px-24 py-12 space-y-2">
      <h1 className="text-3xl">Privacy and Cookie Policy of giuppi.dev</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to giuppi.dev.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            but either generated by the use of the Service or from the Service
            infrastructure itself (for example, the duration of a page visit).
          </p>
        </li>
        <li>
          <p>
            <strong>Website</strong> refers to giuppi.dev, accessible from{" "}
            <a
              href="https://giuppi.dev"
      ...
      <h1 className="text-3xl"> Owner and Data Controller</h1>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>
          Giuseppe Funicello - Via Quintino Sella, 10 - 10090 Castiglione
          Torinese (TO)
        </li>
        <li>Contact by email: info@giuppi.dev</li>
      </ul>
    </div>
  );
}
