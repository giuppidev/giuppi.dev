...
export const Event = ({ event }: { event: any }) => {
  ...
  return (
    <Link
      ...
      className="border-4  border-gray-900   hover:drop-shadow-[8px_8px_0px_#000] hover:-translate-x-1 hover:-translate-y-1 transition-all bg-white  grid grid-rows-[subgrid] row-[span_4] p-4 gap-3"
    >
