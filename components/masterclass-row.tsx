...
const MasterclassRow = ({ course, href=`/corsi/${course.slug}/` }: CourseProps) => {
    ...
    >
      ...
      <div className="h-full flex flex-col justify-between gap-2">
        <div className="flex flex-col gap-1">
          ...
          <h4 className="hidden lg:flex text-base flex-col justify-between ">
